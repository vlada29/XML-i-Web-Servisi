 ...
 * generated in the net.codejava.ws.binary.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadResponse_QNAME = new QName("http://impl.com/", "uploadResponse");
    private final static QName _Upload_QNAME = new QName("http://impl.com/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://impl.com/", "downloadResponse");
    private final static QName _Download_QNAME = new QName("http://impl.com/", "download");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.codejava.ws.binary.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.com/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.com/", name = "download")
